...
that's a my progres learning, also this repo for my personal documentation
...
## Error after start project

Check file /project/vite.config.js 

    Server: [
		Port : 3013 //change the port if the port are same
	]

## Bugs 🐞 ?

Leve your comment on this repo for ask what's your problem

This code make with ❤️ Love yout you muach